...
class HospitalAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Trust", {"fields": ("trust", "trust_since", "previous_trusts")}),
        (
            "Dates",
            {
                "fields": (
                    "foundation_year",
                    "foundation_year_approximate",
                    "closed",
                    "closure_date",
                    "closure_year_approximate",
                )
            },
        ),
        (
        ...
        (
            ...
            {
                "fields": (
                    "pre_1982_regional_authority",
                    "post_1982_regional_authority",
                    "pre_1982_district_authority",
                    "post_1982_district_authority",
                )
            },
        ),
        (
