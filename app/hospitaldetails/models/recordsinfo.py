...
class RecordsInfo(NH3CleanSaveMixin, models.Model):
    ...
    finding_aids = models.ManyToManyField(
        "hospitaldetails.FindingAids", blank=True, related_name="records_info"
    )
    finding_aids_location = models.ManyToManyField(
        "hospitaldetails.FindingAidsLocation", blank=True, related_name="records_info"
    )
